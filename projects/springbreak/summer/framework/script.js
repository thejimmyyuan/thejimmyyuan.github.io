...
function populateArray() {
    ...
    for (i = 0; i < locations.length; i++) {
        ...
        tuesdayy = locations[i].getElementsByTagName('tuesdayy')[0].childNodes[0].nodeValue;

        wednesdayy = locations[i].getElementsByTagName('wednesdayy')[0].childNodes[0].nodeValue;

        thursdayy = locations[i].getElementsByTagName('thursdayy')[0].childNodes[0].nodeValue;
        ...
        dining.tuesdayy = tuesdayy;

        dining.wednesdayy = wednesdayy;

        dining.thursdayy = thursdayy;
...
function showSchedule(optional, title) {
    ...
    var days = ["5/12", "5/13", "5/14", "5/15", "5/16", "5/17", "5/18", "5/19", "5/20", "5/21","5/22"];

    for (i = 0; i < diningAreas.length; i++) {

        if (text == diningAreas[i].name) {
        	times.push(diningAreas[i].tuesdayy.split(","));
        
        	times.push(diningAreas[i].wednesdayy.split(","));
        	
        	times.push(diningAreas[i].thursdayy.split(","));
